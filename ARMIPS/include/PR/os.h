...
extern s32 osEepromProbe(OSMesgQueue *Queue);
extern s32 osEepromRead(OSMesgQueue *Queue, u8 Address, u8 *Destination);
extern s32 osEepromWrite(OSMesgQueue *Queue, u8 Address, u8 *Destination);
extern s32 osEepromLongRead(OSMesgQueue *Queue, u8 Address, u8 *Destination, int Length);
extern s32 osEepromLongWrite(OSMesgQueue *Queue, u8 Address, u8 *Destination, int Length);

/* MOTOR interface */

extern s32 osMotorInit(OSMesgQueue *Queue, OSPfs *, int);
