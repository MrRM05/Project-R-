.definelabel titleControler, 0x800B1C40
.definelabel Na_SE_Fadeout, 0x800CA388
.definelabel pause_flag, 0x800DC5FC //u16
.definelabel map_number_chart, 0x800F2BB4
.definelabel circuit_name, 0x800EF8C9
.definelabel circuit_name_j, 0x800E7574
.definelabel class_name, 0x800E76CC
.definelabel race_level, 0x800DC548
.definelabel gp_pause_message_positions, 0x800E85C0
.definelabel ta_result_select_j, 0x800E775C



.definelabel lap_list, 0x800E4570
.definelabel kwsprite32x16, 0x8004CB90
.definelabel kwsprite_xlu, 0x8004C9D8
.definelabel kwprintlaptime_xlu, 0x8004F950
.definelabel kwgoalcnt, 0x8018D320 
.definelabel kwbesttotalsw, 0x801657E5
.definelabel kwbestlap, 0x80165658
.definelabel kwbestlapsw, 0x801657E3
.definelabel kwprintlaptime, 0x8004F7F4
.definelabel kwprintlaptime_flash,0x8004F9CC
.definelabel replay_flag, 0x8015F890
...
.definelabel SetWord2_a, 0x80093324
.definelabel SetWord2_ap, 0x80093358
.definelabel SetWord3, 0x8009338C
.definelabel SetWord3_a, 0x800936B8
.definelabel SetWord3_ac, 0x800936EC
.definelabel SetWord3_ap, 0x80093720
.definelabel SetWord3_acp, 0x80093754
.definelabel SetWord4, 0x80093788
.definelabel SetWord4_a, 0x800939C8
.definelabel SetWord4_ap, 0x800939FC
...
.definelabel GraphPtrHamp, 0x80150298
.definelabel GraphPtrOG, 0x80150298
...
.definelabel SetCursorMessageColor, 0x800921C0
.definelabel maximum_x, 0x8015F6E8 
.definelabel minimum_x, 0x8015F6EA
.definelabel maximum_y, 0x8015F6EC
.definelabel minimum_y, 0x8015F6EE
.definelabel maximum_z, 0x8015F6F0
.definelabel minimum_z, 0x8015F6F2

.definelabel g_aspectRatio, 0x80150148
.definelabel g_farClip, 0x8015014C
//Itembox
.definelabel screen_view_angle, 0x80150130
.definelabel check_display_range, 0x802B80D0
.definelabel create_modeling_matrix, 0x802B5F74
.definelabel set_matrix, 0x802B4FF8
.definelabel scaling_matrix, 0x802B5F00
.definelabel translate_matrix, 0x802B5450
.definelabel out_of_screen, 0x80297230
.definelabel on_screen, 0x802972B8
.definelabel move_itembox, 0x802A1600
.definelabel move_fake_itembox, 0x802A10F0
.definelabel move_special_itembox, 0x802A156C
.definelabel set_object_buffer, 0x80296D10

//140,118  xy width/height
.definelabel g_ScreenStruct, 0x8015F480
.definelabel GlobalScreen, 0x8015F480
...
.definelabel g_hudAnimStruct, 0x80165C18
.definelabel g_hudStruct, 0x8018CA70

.definelabel UnknFlagShroomsTT, 0x80165888 
.definelabel itemboxtbl_pal, 0x800E44F0 
.definelabel itemboxtbl_idx, 0x800E4530
.definelabel itemboxallocptr, 0x80183E88
.definelabel kwanm_roulette_init, 0x8007B254
.definelabel kwadd_sval, 0x80040FD8
.definelabel kwanm_next, 0x80072488
.definelabel kwanm_forward, 0x80072E54
.definelabel kwanm_randomitem, 0x8007AFB0
.definelabel kwanm_swap, 0x80072D3C
.definelabel kwanm_clrevflag, 0x800722CC
.definelabel kwchart_off, 0x80073600
.definelabel kwanm_wait, 0x8007278C
.definelabel kwanm_finish, 0x80072428
.definelabel kwanm_jump, 0x800726CC
.definelabel kwanm_bitcheckevflag, 0x80072320
.definelabel kwanm_bitoffcheckevflag, 0x80072354
.definelabel kwsteal_item, 0x8007B040
.definelabel kwanm_setoutput, 0x800729D0
.definelabel kwanm_start, 0x800723A4
.definelabel kwsub_sval, 0x8004106C
.definelabel kwanm_roulette, 0x8007B34C
.definelabel kwanm_useditem,0x8007AC9C
.definelabel kwsprite40x32_ci8, 0x8004E4CC
.definelabel kwtexture2D_ci8_bl, 0x80047910
.definelabel kwcheck_opening_start, 0x8005A99C
.definelabel kwscreen_enable, 0x8018D188
.definelabel execute_item, 0x802B2FA0
...
.definelabel kartrank, 0x80165270
.definelabel title_mode, 0x8018EDEF
//GP POINTS
.definelabel d_points, 0x8018D9C8 
.definelabel additional_point, 0x8018D9BC 
.definelabel d_points_rank, 0x8018D9D0
.definelabel players, 0x8018EDF3
.definelabel frame_counter, 0x800DC54C
.definelabel name_to_num, 0x80164478
.definelabel SortDPRanking, 0x800A3A10
.definelabel k_skip_flg, 0x8018D9D8
.definelabel oga_demo_skip_ok_flag, 0x800DDB24
.definelabel SkipReset, 0x800921B4

.definelabel cup_name, 0x800E7500
.definelabel popup_status, 0x800E86AD
.definelabel play_mode, 0x800E86AB
.definelabel cup_level, 0x800DC540
.definelabel retry_count, 0x8016556E
.definelabel ogawa_rank, 0x801643B8

.definelabel kawano_itoa, 0x800A7894

//GP NAMES
.definelabel ResultSub_time, 0x800A32B4
.definelabel ResultSub_point, 0x800A3ADC
.definelabel drivers_name_j, 0x800E76A8
.definelabel goalintime, 0x8015F898
.definelabel rank_to_num, 0x80164360
.definelabel DispOB_result_time, 0x800A2EB8
...
.definelabel DispOBJBlock, 0x8009F5E0
.definelabel gselControler, 0x800B29D8

.definelabel gsel_mode, 0x8018EDED
.definelabel FillRect1ColorFog, 0x80098DF8

.definelabel psel_mode, 0x8018EDEE
.definelabel msel_mode, 0x8018EDEC

.definelabel DOB_msel_anime_mapman, 0x800AB314

.definelabel DOB_msel_anime_map2, 0x800AB290
.definelabel DOB_msel_name, 0x800AB260
.definelabel mselControler, 0x800B3B58

.definelabel circuit_select, 0x8018EE0B
.definelabel cup_select, 0x8018EE09
.definelabel cup_number, 0x800DC544

.definelabel SetFadeOut_b, 0x8009E208

.definelabel grid_x, 0x80165210
.definelabel grid_z, 0x80165230
.definelabel imageinit, 0x8005D290
.definelabel initial_camera, 0x8001C4D0
.definelabel sequence_mode, 0x800DC50C
.definelabel new_sequence_mode, 0x800DC524
.definelabel next_sequence_mode, 0x80150124
.definelabel demo_flag, 0x800DC51C
.definelabel race_screen_mode, 0x800DC530
.definelabel screen_mode, 0x800DC52C //u32
.definelabel result_pos, 0x8003CD78
.definelabel reset_pos, 0x8003C0F0
.definelabel init_draw, 0x8003CD98
.definelabel camera1, 0x800DDB40
.definelabel camera2, 0x800DDB44
.definelabel camera3, 0x800DDB48
.definelabel camera4, 0x800DDB4C
.definelabel change_opneview, 0x8001F87C
